...
sleep 2
wget https://github.com/Dash-Diamond/DASHD/releases/download/v1.1.1.0/DASHD-1.1.1.0-Linux.zip
...
CONF_DIR=~/.dashdiamond/
CONF_FILE=dashdiamond.conf
PORT=12341
...
echo "rpcport=23452" >> $CONF_DIR/$CONF_FILE
