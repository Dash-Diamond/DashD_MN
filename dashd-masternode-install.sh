...
COIN_TGZP='https://github.com/Dash-Diamond/DASHD/releases/download/v2.0.0.0/DASHD-2.0.0.0-Linux.zip'
COIN_BOOTSTRAP='https://github.com/Dash-Diamond/DASHD/releases/download/v2.0.0.0/bootstrap.zip'
