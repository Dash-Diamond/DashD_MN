...
COIN_TX='dashdiamond-tx'
COIN_PATH='/usr/local/bin/'
OS_VERSION=$(lsb_release -d)
COIN_TGZP='https://github.com/Dash-Diamond/DASHD/releases/download/v1.1.0.0/DASHD-1.1.0.0-Linux.zip'
COIN_BOOTSTRAP='https://github.com/Dash-Diamond/DASHD/releases/download/v1.1.0.0/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='dashdiamond'
COIN_NAME_OLD='dashdiamond'
PROJECT_NAME='DashDiamond (DASHD)'
COIN_EXPLORER='https://chains.trittium.cc/DASHD/blocks'
COIN_PORT=12341
RPC_PORT=23452
...
function important_information() {
 ...
 echo -e "You can also use ${RED}dashdiamond-cli getinfo${NC}, ${RED}dashdiamond-cli getblockcount${NC}, ${RED}dashdiamond-cli getmasternodewinners${NC} and ${RED}dashdiamond-cli getblockchaininfo${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
